...
/// ),
///
class WaveStepLine extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _WaveStepLineState();
  }
}

class _WaveStepLineState extends State<WaveStepLine> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        CustomPaint(
          painter: _WaveStepLinePainter(
  ...
  List<Color> _buildLineColor() {
    ...
    if (widget.lineColor != null) {
      if (widget.lineColor is Color) {
        ...
        lineColor.clear();
        lineColor.add(widget.highlightColor ?? Get.theme.colorScheme.primary);
        return lineColor;
      }
    } else {
      if (widget.isGrey) {
      ...
      return [widget.highlightColor ?? Get.theme.colorScheme.primary];
    }
  }
  ...
  Widget _buildHighLightCircle() {
    return _buildColorCircleWidget(
        widget.highlightColor ?? Get.theme.colorScheme.primary);
  }
...
class _WaveStepLinePainter extends CustomPainter {
