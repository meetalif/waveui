...
import 'package:waveui/src/components/picker/time_picker/date_picker/wave_datetime_widget.dart';
import 'package:waveui/src/components/picker/time_picker/date_picker/wave_time_widget.dart';
import 'package:waveui/src/theme/wave_theme.dart';
import 'package:waveui/src/utils/i18n/wave_date_picker_i18n.dart';
import 'package:flutter/material.dart';

///时间选择模式枚举
enum WaveDateTimePickerMode {
  /// Display DatePicker
  date,
...
class WaveDatePicker {
  ...
  /// pickerMode: [WaveDateTimePickerMode] display mode: date(DatePicker)、time(TimePicker)、datetime(DateTimePicker)
  /// pickerTheme: [WavePickerTitleConfig] the theme of date time picker
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    this.minuteDivider,
    this.dateFormat,
    this.pickerMode = WaveDateTimePickerMode.date,
  ...
  final WaveDateTimePickerMode pickerMode;
  ...
  Widget build(BuildContext context) {
    ...
    switch (route.pickerMode) {
      ...
      case WaveDateTimePickerMode.datetime:
        pickerWidget = WaveDateTimeWidget(
          minDateTime: route.minDateTime,
          maxDateTime: route.maxDateTime,
          initDateTime: route.initialDateTime,
          dateFormat: route.dateFormat,
