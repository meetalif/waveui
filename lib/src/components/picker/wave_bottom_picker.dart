  ...
  static void show(
    ...
    showGeneralDialog(
      ...
      pageBuilder: (BuildContext buildContext, Animation<double> animation,
        ...
        final Widget pageChild = WaveBottomPickerWidget(
...
class WaveBottomPickerWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return WaveBottomPickerWidgetState();
  }
}

class WaveBottomPickerWidgetState extends State<WaveBottomPickerWidget>
  ...
  Widget? _buildConfirmWidget() {
    ...
    if (widget.confirm is Widget) {
      ...
      confirmWidget =
          _buildDefaultConfirm(WaveIntl.of(context).localizedResource.confirm);
    }
  ...
  Widget? _buildCancelWidget() {
    ...
    if (widget.cancel is Widget) {
      ...
      cancelWidget =
          _buildDefaultCancel(WaveIntl.of(context).localizedResource.cancel);
    }
    return cancelWidget;
  }
  ...
  Widget _buildDefaultConfirm(String string) {
    return Text(
      string,
      style: TextStyle(color: Get.theme.colorScheme.primary, fontSize: 16.0),
  ...
  Widget _buildDefaultCancel(String? string) {
    return Text(
      string ?? WaveIntl.of(context).localizedResource.cancel,
      style: TextStyle(
