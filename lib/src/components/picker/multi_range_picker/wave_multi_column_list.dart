...
/// [index] 点击位置处于当前列的位置
/// [entity] 被点击位置的数据
typedef WaveOnSelectEntityInterceptor = bool Function(
...
class WaveMultiColumnListWidget extends StatefulWidget {
  ...
  @override
  _WaveMultiColumnListWidgetState createState() =>
      _WaveMultiColumnListWidgetState();
...
class _WaveMultiColumnListWidgetState extends State<WaveMultiColumnListWidget> {
  ...
  void _processFilterData(WavePickerEntity? selectedEntity) {
    ...
    int totalLevel =
        WaveMultiColumnPickerUtil.getTotalColumnCount(selectedEntity);
  ...
  void _configSecondList(
      WavePickerEntity selectedEntity, int? currentListIndex) {
