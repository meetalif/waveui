...
class WaveMiddleInputDialog {
  ...
  void _doShow(BuildContext context) {
    ...
    return WaveDialogManager.showConfirmDialog(context,
        cancel: cancelText ?? WaveIntl.of(context).localizedResource.cancel,
        confirm: confirmText ?? WaveIntl.of(context).localizedResource.ok,
        title: title,
