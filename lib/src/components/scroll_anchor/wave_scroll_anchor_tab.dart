...
class WaveAnchorTab extends StatefulWidget {
  // TabBar的样式
  final WaveAnchorTabBarStyle tabBarStyle;
  ...
  @override
  _WaveScrollAnchorTabWidgetState createState() =>
      _WaveScrollAnchorTabWidgetState();
}

class _WaveScrollAnchorTabWidgetState extends State<WaveAnchorTab>
  ...
  @override
  void didUpdateWidget(WaveAnchorTab oldWidget) {
