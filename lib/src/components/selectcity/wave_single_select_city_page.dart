...
import 'package:waveui/src/components/empty/wave_empty_status.dart';
...
import 'package:waveui/src/components/selectcity/wave_az_listview.dart';
import 'package:waveui/src/components/selectcity/wave_select_city_model.dart';
import 'package:waveui/src/components/sugsearch/wave_search_text.dart';
...
class _WaveSingleSelectCityPageState extends State<WaveSingleSelectCityPage> {
  ...
  void _loadData() async {
    if (widget.cityList == null || widget.cityList!.isEmpty) {
      ...
      rootBundle
          .loadString(
              'packages/${WaveStrings.flutterPackageName}/assets/json/china.json')
          .then((value) {
