import 'package:waveui/src/components/appraise/wave_flutter_gif_image.dart';
...
/// 表情点击的回调
/// index 点击的表情的index
typedef WaveAppraiseEmojiClickCallback = void Function(int index);

class WaveAppraiseEmojiItem extends StatefulWidget {
  ...
  /// 点击的回调
  final WaveAppraiseEmojiClickCallback? onTap;
  ...
  @override
  _WaveAppraiseEmojiItemState createState() => _WaveAppraiseEmojiItemState();
}

class _WaveAppraiseEmojiItemState extends State<WaveAppraiseEmojiItem>
  ...
  @override
  void didUpdateWidget(WaveAppraiseEmojiItem oldWidget) {
    _selectedIndex = widget.selectedIndex;
