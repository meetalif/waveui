...
class WaveSelectionRangeTagWidget extends StatefulWidget {
  ...
  @override
  _WaveSelectionRangeTagWidgetState createState() =>
      _WaveSelectionRangeTagWidgetState();
}

class _WaveSelectionRangeTagWidgetState
    extends State<WaveSelectionRangeTagWidget> {
  @override
