...
///页面类型保罗了：标题、选择框
class WaveFlatMoreSelection extends StatefulWidget {
  /// 数据源
  ...
  @override
  _WaveFlatMoreSelectionState createState() => _WaveFlatMoreSelectionState();
}

class _WaveFlatMoreSelectionState extends State<WaveFlatMoreSelection> {
  @override
...
class __FilterCommonTypeWidgetState extends State<_FilterCommonTypeWidget> {
  ...
  Widget _buildSingleTag(WaveSelectionEntity data) {
    bool isDate = data.filterType == WaveSelectionFilterType.date;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(WaveIntl.of(context).localizedResource.more,
