...
import 'package:waveui/src/components/tabbar/indicator/wave_custom_width_indicator.dart';
import 'package:flutter/material.dart';

/// 描述: 一级切换标题

class WaveSwitchTitle extends StatefulWidget {
  /// 标题的文案列表
  ...
  @override
  _WaveSwitchTitleState createState() => _WaveSwitchTitleState();
}
...
class _WaveSwitchTitleState extends State<WaveSwitchTitle>
  ...
  @override
  void didUpdateWidget(WaveSwitchTitle oldWidget) {
