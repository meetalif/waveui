...
class WaveSubSwitchTitle extends StatefulWidget {
  /// 标题的文案列表
  ...
  @override
  _WaveSubSwitchTitleState createState() => _WaveSubSwitchTitleState();
}

class _WaveSubSwitchTitleState extends State<WaveSubSwitchTitle>
  ...
  @override
  void didUpdateWidget(WaveSubSwitchTitle oldWidget) {
