...
/// )
/// 相关按钮如下:
///  * [WaveActionCardTitle], 右侧为箭头的卡片标题组件
///
class WaveCommonCardTitle extends StatelessWidget {
  /// 标题
  final String title;
  ...
  Widget build(BuildContext context) {
    ...
    WaveCardTitleConfig cardTitleConfig = WaveCardTitleConfig(
        alignment: alignment,
        cardTitlePadding: padding as EdgeInsets?,
        detailTextStyle: WaveTextStyle(color: detailColor));
  ...
  ///标题widget
  Widget _titleWidget(BuildContext context, WaveCardTitleConfig defaultConfig) {
  ...
  ///标题下方的widget
  Widget _detailTextWidget(WaveCardTitleConfig defaultConfig) {
    Text tx = Text(
      detailTextString ?? "",
