import 'package:waveui/src/components/button/wave_small_main_button.dart';
import 'package:waveui/src/components/button/wave_small_outline_button.dart';
import 'package:waveui/src/components/popup/wave_popup_window.dart';
...
class WaveButtonPanel extends StatefulWidget {
  /// 主按钮的文案
  ...
  final List<WaveButtonPanelConfig>? secondaryButtonList;
  ...
  @override
  _WaveButtonPanelState createState() => _WaveButtonPanelState();
}

class _WaveButtonPanelState extends State<WaveButtonPanel> {
  late GlobalKey _popWindowKey;

  List<WaveButtonPanelConfig> _secondaryButtonList = [];
  ...
  @override
  void didUpdateWidget(WaveButtonPanel oldWidget) {
    initSecondaryButton();
  ...
  Widget _secondaryButton(int btnIndex) {
    WaveSmallOutlineButton button = WaveSmallOutlineButton(
