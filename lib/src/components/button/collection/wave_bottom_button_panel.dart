...
import 'package:waveui/src/components/button/wave_vertical_icon_button.dart';
...
///
/// 相关按钮如下:
///  * [WaveButtonPanel], 小主次按钮组成的横向面板
///  * [WaveMultipleBottomButton], 具备编辑选择状态的底部操作按钮
///  * [WaveTextButtonPanel], 平分可用空间的文本按钮面板
///  * [WaveVerticalIconButton], 小主次按钮组成的横向面板
///
class WaveBottomButtonPanel extends StatelessWidget {
  /// 主按钮的文案
  ...
  /// icon按钮的集合
  final List<WaveVerticalIconButton>? iconButtonList;
