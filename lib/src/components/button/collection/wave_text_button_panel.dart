...
class WaveTextButtonPanel extends StatefulWidget {
  /// 操作文字列表
  ...
  @override
  _WaveTextButtonPanelState createState() => _WaveTextButtonPanelState();
}
  ...
  Widget _moreButton() {
    if (widget.nameList.length > _maxNum) {
      ...
      Widget imageWidget = _isExpanded
          ? WaveUITools.getAssetImage(WaveAsset.iconUpArrow)
          : WaveUITools.getAssetImage(WaveAsset.iconDownArrow);
