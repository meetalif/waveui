...
class WaveMultiChoiceInputFormItem extends StatefulWidget {
  /// 录入项的唯一标识，主要用于录入类型页面框架中
  final String? label;

  /// 录入项类型，主要用于录入类型页面框架中
  final String type = WaveInputItemType.multiChoiceInputType;
  ...
  /// 选项选中状态变化回调
  final OnWaveFormMultiChoiceValueChanged? onChanged;
  ...
  @override
  WaveMultiChoiceInputFormItemState createState() {
    return WaveMultiChoiceInputFormItemState();
  }
}

class WaveMultiChoiceInputFormItemState
    extends State<WaveMultiChoiceInputFormItem> {
              ...
              WaveCheckbox(
                ...
                onValueChangedAtIndex: (position, value) {
                  ...
                  setState(() {
                    ...
                    WaveFormUtil.notifyMultiChoiceStatusChanged(
