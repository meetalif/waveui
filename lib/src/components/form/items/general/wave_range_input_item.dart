...
class WaveRangeInputFormItem extends StatefulWidget {
  /// 录入项的唯一标识，主要用于录入类型页面框架中
  final String? label;

  /// 录入项类型，主要用于录入类型页面框架中
  String type = WaveInputItemType.textRangeInputType;
  ...
  @override
  WaveRangeInputFormItemState createState() {
    return WaveRangeInputFormItemState();
  }
}

class WaveRangeInputFormItemState extends State<WaveRangeInputFormItem> {
  late TextEditingController _minController;
  late TextEditingController _maxController;
  late WaveFormItemConfig config;

  @override
  void initState() {
    config = WaveThemeConfigurator.instance.getConfig().formItemConfig;
