...
class WaveTextBlockInputFormItem extends StatefulWidget {
  /// 录入项的唯一标识，主要用于录入类型页面框架中
  final String? label;

  /// 录入项类型，主要用于录入类型页面框架中
  final String type = WaveInputItemType.textBlockInputType;
  ...
  @override
  WaveTextBlockInputFormItemState createState() {
    return WaveTextBlockInputFormItemState();
  }
}

class WaveTextBlockInputFormItemState
    extends State<WaveTextBlockInputFormItem> {
