...
class WaveTitleSelectInputFormItem extends StatefulWidget {
  /// 录入项的唯一标识，主要用于录入类型页面框架中
  final String? label;

  /// 录入项类型，主要用于录入类型页面框架中
  final String type = WaveInputItemType.textInputTitleSelectType;
  ...
  /// title文案选中回调
  final OnWaveFormTitleSelected? onTitleSelected;
  ...
  WaveTitleSelectInputFormItem(
      ...
      this.hint,
      this.maxCount,
      this.inputType = WaveInputType.text,
  ...
  @override
  WaveTitleSelectInputFormItemState createState() =>
      WaveTitleSelectInputFormItemState();
}

class WaveTitleSelectInputFormItemState
    extends State<WaveTitleSelectInputFormItem> {
        ...
        builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
          return snapshot.data!
              ? WaveUITools.getAssetImageWithBandColor(
                  WaveAsset.iconSelectedUpTriangle)
