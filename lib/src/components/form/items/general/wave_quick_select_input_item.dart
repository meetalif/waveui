...
class WaveTextQuickSelectFormItem extends StatefulWidget {
  /// 录入项的唯一标识，主要用于录入类型页面框架中
  final String? label;

  /// 录入项类型，主要用于录入类型页面框架中
  String type = WaveInputItemType.textQuickSelectInputType;
  ...
  @override
  WaveTextQuickSelectFormItemState createState() {
    return WaveTextQuickSelectFormItemState();
  }
}

class WaveTextQuickSelectFormItemState
    extends State<WaveTextQuickSelectFormItem> {
  @override
  ...
  Widget buildText() {
    if (widget.value != null && widget.value!.isNotEmpty) {
      ...
      return Text(
        ...
        textAlign: TextAlign.end,
        style: WaveFormUtil.getHintTextStyle(widget.themeData!),
      );
    }
  }
}
