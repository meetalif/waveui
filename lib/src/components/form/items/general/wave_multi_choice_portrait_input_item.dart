...
class WaveMultiChoicePortraitInputFormItem extends StatefulWidget {
  /// 录入项的唯一标识，主要用于录入类型页面框架中
  final String? label;

  /// 录入项类型，主要用于录入类型页面框架中
  String type = WaveInputItemType.multiChoicePortraitInputType;
  ...
  @override
  WaveMultiChoicePortraitInputFormItemState createState() {
    return WaveMultiChoicePortraitInputFormItemState();
  }
}

class WaveMultiChoicePortraitInputFormItemState
    extends State<WaveMultiChoicePortraitInputFormItem> {
