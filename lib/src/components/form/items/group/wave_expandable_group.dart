...
/// [WaveExpandableGroup] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class WaveExpandableGroup extends StatefulWidget {
  ...
  @override
  _WaveExpansionElementState createState() => _WaveExpansionElementState();
}

class _WaveExpansionElementState extends State<WaveExpandableGroup>
  ...
  void initState() {
    ...
    if (_isExpanded) {
      arrowIcon =
          WaveUITools.getAssetSizeImage(WaveAsset.iconDownArrow, 12, 12);
    } else {
      arrowIcon = WaveUITools.getAssetSizeImage(WaveAsset.iconUpArrow, 12, 12);
    }
  }
                      ...
                      Container(
                        ...
                        child: Offstage(
                          ...
                          child: Text(
                            // ignore: deprecated_member_use_from_same_package
                            widget.subtitle ?? "",
                            style: WaveFormUtil.getSubTitleTextStyle(
                                widget.themeData!),
                          ),
                        ),
                      ),
