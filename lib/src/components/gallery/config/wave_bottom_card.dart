...
class WavePhotoBottomCard extends StatefulWidget {
  final String? name;
  final String? des;
  ...
  @override
  _WavePhotoBottomCardState createState() => _WavePhotoBottomCardState();
}

class _WavePhotoBottomCardState extends State<WavePhotoBottomCard>
            ...
            GestureDetector(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Transform.rotate(
                    angle: pi,
                    child: WaveUITools.getAssetImageWithColor(
                        WaveAsset.iconUpArrow, widget.themeData!.iconColor),
                  )
                ],
              ),
            )
