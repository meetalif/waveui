import 'package:waveui/src/components/gallery/config/wave_basic_gallery_config.dart';
import 'package:waveui/src/components/gallery/config/wave_controller.dart';
import 'package:waveui/src/components/gallery/page/wave_gallery_detail_page.dart';
import 'package:waveui/src/components/navbar/wave_appbar.dart';
import 'package:waveui/src/components/scroll_anchor/wave_scroll_anchor_tab.dart';
...
class WaveGallerySummaryPage extends StatefulWidget {
  /// 显示的所有配置信息
  ...
  @override
  _WaveGallerySummaryPageState createState() => _WaveGallerySummaryPageState();
}

class _WaveGallerySummaryPageState extends State<WaveGallerySummaryPage> {
  @override
  void initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(WaveGallerySummaryPage oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: WaveAppBar(
        title: WaveIntl.of(context).localizedResource.allPics,
      ),
  ...
  Widget _body() {
    List<WaveBasicGroupConfig> allConfig = widget.allConfig;
