...
class WaveSelectTag extends StatefulWidget {
  /// 展示的标签列表
  ...
  @override
  _WaveSelectTagState createState() => _WaveSelectTagState();
}

class _WaveSelectTagState extends State<WaveSelectTag> {
  List<bool> _tagState = [];
  ...
  @override
  void didUpdateWidget(WaveSelectTag oldWidget) {
