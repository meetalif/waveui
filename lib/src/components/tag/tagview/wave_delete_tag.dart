...
class WaveDeleteTag extends StatefulWidget {
  ...
  @override
  _WaveDeleteTagState createState() => _WaveDeleteTagState();
}

class _WaveDeleteTagState extends State<WaveDeleteTag> {
  late WaveDeleteTagController _controller;

  @override
  void initState() {
    super.initState();
    _controller =
        widget.controller ?? WaveDeleteTagController(initTags: widget.tags);
  }
  ...
  Widget build(BuildContext context) {
    return Chip(
      ...
      deleteIcon: deleteIconSize != null
          ? WaveUITools.getAssetSizeImage(WaveAsset.iconClose,
              deleteIconSize!.width, deleteIconSize!.height,
              color: deleteIconColor)
          : WaveUITools.getAssetImageWithColor(
              WaveAsset.iconClose, deleteIconColor),
      onDeleted: () {
        debugPrint('$index');
        didDeleted(index);
      },
...
class WaveDeleteTagController {
  ...
  WaveDeleteTagController({List<String>? initTags}) {
    _tags = initTags ?? [];
