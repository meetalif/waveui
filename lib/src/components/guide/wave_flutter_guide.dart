...
import 'package:waveui/src/components/guide/wave_pulse_widget.dart';
import 'package:waveui/src/components/guide/wave_tip_widget.dart';
import 'package:flutter/material.dart';

part 'wave_delay_rendered_widget.dart';

part 'wave_step_widget_builder.dart';

part 'wave_step_widget_params.dart';

part 'wave_throttling.dart';

class WaveTipInfoBean {
  /// 引导标题
  final String title;
  ...
  WaveTipInfoBean(this.title, this.message, this.imgUrl);
}
