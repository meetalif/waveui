...
/// 默认位置，头部
const WaveDashedLinePosition _normalPosition = WaveDashedLinePosition.leading;

/// 虚线分割线
class WaveDashedLine extends StatelessWidget {
...
class WaveDashedPainter extends CustomPainter {
  /// 虚线方向
  final Axis axis;
