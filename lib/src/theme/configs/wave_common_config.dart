...
/// 描述: 全局配置
/// 配置属性：色值、字体大小、间距、圆角
class WaveCommonConfig extends WaveBaseConfig {
  WaveCommonConfig({
    Color? brandPrimary,
  ...
  WaveCommonConfig.autoFlatConfig({
    Color? brandPrimary,
    Color? brandPrimaryTap,
    Color? brandSuccess,
    Color? brandWarning,
...
///////////////////////////////////////////////////////////////////////////////
  ...
  Color get brandPrimaryTap =>
      _brandPrimaryTap ??
      WaveDefaultConfigUtils.defaultCommonConfig.brandPrimaryTap;

  Color get brandSuccess =>
      _brandSuccess ?? WaveDefaultConfigUtils.defaultCommonConfig.brandSuccess;

  Color get brandWarning =>
      _brandWarning ?? WaveDefaultConfigUtils.defaultCommonConfig.brandWarning;

  Color get brandError =>
      _brandError ?? WaveDefaultConfigUtils.defaultCommonConfig.brandError;

  Color get brandImportant =>
      _brandImportant ??
      WaveDefaultConfigUtils.defaultCommonConfig.brandImportant;

  Color get brandImportantValue =>
      _brandImportantValue ??
      WaveDefaultConfigUtils.defaultCommonConfig.brandImportantValue;

  Color get brandAuxiliary =>
      _brandAuxiliary ??
      WaveDefaultConfigUtils.defaultCommonConfig.brandAuxiliary;

  Color get colorTextBase =>
      _colorTextBase ??
      WaveDefaultConfigUtils.defaultCommonConfig.colorTextBase;

  Color get colorTextImportant =>
      _colorTextImportant ??
      WaveDefaultConfigUtils.defaultCommonConfig.colorTextImportant;

  Color get colorTextBaseInverse =>
      _colorTextBaseInverse ??
      WaveDefaultConfigUtils.defaultCommonConfig.colorTextBaseInverse;

  Color get colorTextSecondary =>
      _colorTextSecondary ??
      WaveDefaultConfigUtils.defaultCommonConfig.colorTextSecondary;

  Color get colorTextDisabled =>
      _colorTextDisabled ??
      WaveDefaultConfigUtils.defaultCommonConfig.colorTextDisabled;

  Color get colorTextHint =>
      _colorTextHint ??
      WaveDefaultConfigUtils.defaultCommonConfig.colorTextHint;

  Color get colorLink =>
      _colorLink ?? WaveDefaultConfigUtils.defaultCommonConfig.colorLink;

  Color get fillBase =>
      _fillBase ?? WaveDefaultConfigUtils.defaultCommonConfig.fillBase;

  Color get fillBody =>
      _fillBody ?? WaveDefaultConfigUtils.defaultCommonConfig.fillBody;

  Color get fillMask =>
      _fillMask ?? WaveDefaultConfigUtils.defaultCommonConfig.fillMask;

  Color get borderColorBase =>
      _borderColorBase ??
      WaveDefaultConfigUtils.defaultCommonConfig.borderColorBase;

  Color get dividerColorBase =>
      _dividerColorBase ??
      WaveDefaultConfigUtils.defaultCommonConfig.dividerColorBase;

  double get fontSizeBebas =>
      _fontSizeBebas ??
      WaveDefaultConfigUtils.defaultCommonConfig.fontSizeBebas;

  double get fontSizeHeadLg =>
      _fontSizeHeadLg ??
      WaveDefaultConfigUtils.defaultCommonConfig.fontSizeHeadLg;

  double get fontSizeHead =>
      _fontSizeHead ?? WaveDefaultConfigUtils.defaultCommonConfig.fontSizeHead;

  double get fontSizeSubHead =>
      _fontSizeSubHead ??
      WaveDefaultConfigUtils.defaultCommonConfig.fontSizeSubHead;

  double get fontSizeBase =>
      _fontSizeBase ?? WaveDefaultConfigUtils.defaultCommonConfig.fontSizeBase;

  double get fontSizeCaption =>
      _fontSizeCaption ??
      WaveDefaultConfigUtils.defaultCommonConfig.fontSizeCaption;

  double get fontSizeCaptionSm =>
      _fontSizeCaptionSm ??
      WaveDefaultConfigUtils.defaultCommonConfig.fontSizeCaptionSm;

  double get radiusXs =>
      _radiusXs ?? WaveDefaultConfigUtils.defaultCommonConfig.radiusXs;

  double get radiusSm =>
      _radiusSm ?? WaveDefaultConfigUtils.defaultCommonConfig.radiusSm;

  double get radiusMd =>
      _radiusMd ?? WaveDefaultConfigUtils.defaultCommonConfig.radiusMd;

  double get radiusLg =>
      _radiusLg ?? WaveDefaultConfigUtils.defaultCommonConfig.radiusLg;

  double get borderWidthSm =>
      _borderWidthSm ??
      WaveDefaultConfigUtils.defaultCommonConfig.borderWidthSm;

  double get borderWidthMd =>
      _borderWidthMd ??
      WaveDefaultConfigUtils.defaultCommonConfig.borderWidthMd;

  double get borderWidthLg =>
      _borderWidthLg ??
      WaveDefaultConfigUtils.defaultCommonConfig.borderWidthLg;

  double get hSpacingXs =>
      _hSpacingXs ?? WaveDefaultConfigUtils.defaultCommonConfig.hSpacingXs;

  double get hSpacingSm =>
      _hSpacingSm ?? WaveDefaultConfigUtils.defaultCommonConfig.hSpacingSm;

  double get hSpacingMd =>
      _hSpacingMd ?? WaveDefaultConfigUtils.defaultCommonConfig.hSpacingMd;

  double get hSpacingLg =>
      _hSpacingLg ?? WaveDefaultConfigUtils.defaultCommonConfig.hSpacingLg;

  double get hSpacingXl =>
      _hSpacingXl ?? WaveDefaultConfigUtils.defaultCommonConfig.hSpacingXl;

  double get hSpacingXxl =>
      _hSpacingXxl ?? WaveDefaultConfigUtils.defaultCommonConfig.hSpacingXxl;

  double get vSpacingXs =>
      _vSpacingXs ?? WaveDefaultConfigUtils.defaultCommonConfig.vSpacingXs;

  double get vSpacingSm =>
      _vSpacingSm ?? WaveDefaultConfigUtils.defaultCommonConfig.vSpacingSm;

  double get vSpacingMd =>
      _vSpacingMd ?? WaveDefaultConfigUtils.defaultCommonConfig.vSpacingMd;

  double get vSpacingLg =>
      _vSpacingLg ?? WaveDefaultConfigUtils.defaultCommonConfig.vSpacingLg;

  double get vSpacingXl =>
      _vSpacingXl ?? WaveDefaultConfigUtils.defaultCommonConfig.vSpacingXl;

  double get vSpacingXxl =>
      _vSpacingXxl ?? WaveDefaultConfigUtils.defaultCommonConfig.vSpacingXxl;

  double get iconSizeXxs =>
      _iconSizeXxs ?? WaveDefaultConfigUtils.defaultCommonConfig.iconSizeXxs;

  double get iconSizeXs =>
      _iconSizeXs ?? WaveDefaultConfigUtils.defaultCommonConfig.iconSizeXs;

  double get iconSizeSm =>
      _iconSizeSm ?? WaveDefaultConfigUtils.defaultCommonConfig.iconSizeSm;

  double get iconSizeMd =>
      _iconSizeMd ?? WaveDefaultConfigUtils.defaultCommonConfig.iconSizeMd;

  double get iconSizeLg =>
      _iconSizeLg ?? WaveDefaultConfigUtils.defaultCommonConfig.iconSizeLg;

  /// 优先级 [GLOBAL_CONFIG_ID] 获取配置 > [WAVEUI_CONFIG_ID] 获取配置
  @override
